...
public class CustomerTaskRunner implements Runnable, IWorker{
	...
	public CustomerTaskRunner(ISimulator simulator, Workload workloadType) {
    ...
    protected void executeStep(WorkloadStep step) {
